...

{
    ...
    answer: 0,
    explanation: "Green plants (grass) make their own food by photosynthesis, so they are producers."
},

{
    ...
    difficulty: "Easy",
    pyq: true,
    question: "Organisms that break down the dead bodies of plants and animals into simple substances are called:",
    options: ["Parasites", "Producers", "Consumers", "Decomposers"],
    answer: 3,
    explanation: "Bacteria and fungi (decomposers) break down dead organic matter into simple substances."
},

{
    ...
    options: ["Plastic", "Wood", "Paper", "Fruit peel"],
    answer: 0,
    explanation: "Plastic cannot be broken down by microorganisms, so it is non-biodegradable."
},

{
    ...
    difficulty: "Easy",
    pyq: true,
    question: "In a food chain, green plants occupy the:",
    options: ["Second trophic level", "Third trophic level", "Fourth trophic level", "First trophic level"],
    answer: 3,
    explanation: "Producers (green plants) always form the first trophic level."
},

{
    ...
    difficulty: "Medium",
    pyq: true,
    question: "The 10% law in an ecosystem is related to the transfer of:",
    options: ["Water", "Energy", "Oxygen", "Minerals"],
    answer: 1,
    explanation: "Only about 10% of the energy is transferred from one trophic level to the next."
},

{
    ...
    difficulty: "Medium",
    pyq: true,
    question: "If 10,000 J of energy is available at the producer level, the energy available to the secondary consumer is:",
    options: ["1 J", "1000 J", "100 J", "10 J"],
    answer: 2,
    explanation: "Producer 10,000 J → primary consumer 1,000 J → secondary consumer 100 J (10% at each step)."
},

{
    ...
    difficulty: "Medium",
    pyq: true,
    question: "In a food chain contaminated with DDT, the maximum concentration of the toxin will be found in:",
    options: ["Secondary consumers", "Top carnivores", "Producers", "Primary consumers"],
    answer: 1,
    explanation: "Non-biodegradable chemicals accumulate at higher trophic levels — biological magnification."
},

{
    ...
    difficulty: "Easy",
    pyq: true,
    question: "Depletion of the ozone layer is mainly caused by:",
    options: ["Chlorofluorocarbons (CFCs)", "Methane", "Oxygen", "Carbon dioxide"],
    answer: 0,
    explanation: "CFCs (used in refrigerants and aerosols) destroy the ozone layer."
},

{
    ...
    answer: 1,
    explanation: "Ozone is formed in the stratosphere, where it shields the Earth from UV radiation."
},

{
    ...
    difficulty: "Easy",
    pyq: true,
    question: "An ozone molecule is made up of:",
    options: ["Four oxygen atoms", "One oxygen atom", "Two oxygen atoms", "Three oxygen atoms"],
    answer: 3,
    explanation: "Ozone is O₃ — three oxygen atoms joined together."
},

{
    ...
    difficulty: "Easy",
    pyq: true,
    question: "A food web is formed by:",
    options: ["Only producers", "Only decomposers", "A single food chain", "Interconnected food chains"],
    answer: 3,
    explanation: "A food web is a network of interconnected food chains in an ecosystem."
},

{
    ...
    options: ["Polythene bag", "Vegetable peel", "Aluminium foil", "Glass bottle"],
    answer: 1,
    explanation: "Vegetable peel is broken down by microorganisms, so it is biodegradable."
},

{
    ...
    difficulty: "Medium",
    pyq: true,
    question: "The flow of energy in a food chain is:",
    options: ["Bidirectional", "Unidirectional", "Cyclic", "Random"],
    answer: 1,
    explanation: "Energy flows only from producers to consumers and never returns to producers — it is unidirectional."
},

{
    ...
    difficulty: "Medium",
    pyq: false,
    question: "The main role of decomposers in an ecosystem is:",
    options: ["Releasing oxygen", "Producing food", "Recycling nutrients", "Absorbing sunlight"],
    answer: 2,
    explanation: "Decomposers return nutrients to the soil so producers can use them again — nutrient recycling."
},

{
    ...
    difficulty: "Medium",
    pyq: true,
    question: "The third trophic level of a food chain is usually occupied by:",
    options: ["Carnivores (secondary consumers)", "Top carnivores", "Producers", "Herbivores"],
    answer: 0,
    explanation: "T1 = producers, T2 = herbivores, T3 = small carnivores (secondary consumers)."
},

{
    ...
    difficulty: "Easy",
    pyq: true,
    question: "Herbivores are also called:",
    options: ["Primary consumers", "Secondary consumers", "Decomposers", "Producers"],
    answer: 0,
    explanation: "Herbivores eat producers, so they are primary consumers (second trophic level)."
},

{
    ...
    options: ["Bacteria", "Sunlight", "Plants", "Animals"],
    answer: 1,
    explanation: "Abiotic components are non-living factors such as sunlight, air, water and soil."
},

{
    ...
    options: ["Only plants", "Only living organisms", "Only non-living things", "Both biotic and abiotic components"],
    answer: 3,
    explanation: "An ecosystem is the interaction of biotic (living) and abiotic (non-living) components."
},

{
    ...
    difficulty: "Easy",
    pyq: false,
    question: "Which practice helps reduce environmental pollution?",
    options: ["Dumping plastic in rivers", "Cutting forests", "Burning garbage", "Using paper bags"],
    answer: 3,
    explanation: "Paper bags are biodegradable and reduce plastic pollution."
},

{
    ...
    difficulty: "Easy",
    pyq: true,
    question: "The 3 Rs for environmental protection stand for:",
    options: ["Reduce, Reuse, Recycle", "Rotate, Reuse, React", "Reduce, React, Recycle", "Read, Register, Recall"],
    answer: 0,
    explanation: "Reduce, Reuse and Recycle help minimise waste and protect the environment."
},

{
    ...
    options: ["Water purification", "Disposal of waste by burning", "Recycling plastic", "Making compost"],
    answer: 1,
    explanation: "Incineration burns waste at high temperature to reduce its volume."
},

{
    ...
    difficulty: "Easy",
    pyq: false,
    question: "The maximum energy in a food chain is available at the level of:",
    options: ["Tertiary consumers", "Producers", "Primary consumers", "Secondary consumers"],
    answer: 1,
    explanation: "Producers trap solar energy, so the first trophic level has the maximum energy."
},

{
    ...
    difficulty: "Hard",
    pyq: true,
    question: "If the energy available at the fourth trophic level is 5 kJ, the energy at the producer level would be:",
    options: ["5000 kJ", "0.5 kJ", "50 kJ", "500 kJ"],
    answer: 0,
    explanation: "Working backwards: T4 = 5 kJ → T3 = 50 kJ → T2 = 500 kJ → T1 (producer) = 5000 kJ."
},

{
    ...
    options: ["Secondary consumer", "Tertiary consumer", "Producer", "Primary consumer"],
    answer: 0,
    explanation: "Grasshopper (primary consumer) is eaten by the frog, so the frog is a secondary consumer (T3)."
},

{
    ...
    difficulty: "Easy",
    pyq: false,
    question: "Which of the following is NOT a consumer?",
    options: ["Algae", "Deer", "Tiger", "Earthworm"],
    answer: 0,
    explanation: "Algae are green and photosynthesise, so they are producers, not consumers."
},

{
    ...
    difficulty: "Easy",
    pyq: true,
    question: "Which of the following groups includes decomposers?",
    options: ["Grass and algae", "Bacteria and fungi", "Plants and animals", "Lions and tigers"],
    answer: 1,
    explanation: "Bacteria and fungi act on dead organisms and are the decomposers of an ecosystem."
},

{
    ...
    difficulty: "Medium",
    pyq: false,
    question: "Assertion (A): The number of trophic levels in a food chain is generally limited to 3–4.\nReason (R): Energy decreases at each higher trophic level as heat.",
    ...
    answer: 2,
    explanation: "About 90% of energy is lost at each step, so very little remains after 3–4 levels — R correctly explains A."
},

{
    ...
    difficulty: "Medium",
    pyq: false,
    question: "Assertion (A): Ozone in the stratosphere protects life on Earth.\nReason (R): Ozone absorbs harmful ultraviolet radiation from the Sun.",
    options: ["Both A and R are true but R does not explain A", "A is true but R is false", "A is false but R is true", "Both A and R are true and R explains A"],
    answer: 3,
    explanation: "The protective role of ozone comes from its absorption of UV radiation — R explains A."
},

{
    ...
    difficulty: "Medium",
    pyq: false,
    question: "Case study: A pond near a farm shows DDT traces of 0.002 ppm in water. Which organism in the pond food chain (Phytoplankton → Small fish → Large fish → Fish-eating bird) will show the highest DDT concentration?",
    options: ["Phytoplankton", "Small fish", "Large fish", "Fish-eating bird"],
    answer: 3,
    explanation: "Biological magnification: non-biodegradable DDT keeps concentrating at each trophic level, maximum in the top organism."
},

{
    ...
    difficulty: "Medium",
    pyq: false,
    question: "Case study: In the food chain Grass → Grasshopper → Frog → Snake → Peacock, the producers trap 200 J of energy. The energy received by the peacock will be:",
    options: ["20 J", "0.2 J", "0.02 J", "2 J"],
    answer: 2,
    explanation: "T1 = 200 J → T2 = 20 J → T3 = 2 J → T4 = 0.2 J → T5 (peacock) = 0.02 J."
},

{
    ...
    difficulty: "Easy",
    pyq: false,
    question: "In most terrestrial ecosystems, the largest number of organisms is found among:",
    options: ["Herbivores", "Producers", "Top carnivores", "Carnivores"],
    answer: 1,
    explanation: "The pyramid of numbers usually has the largest base — the producers."
},

{
    ...
    options: ["Biodegradable waste into manure", "Metal into ore", "Glass into sand", "Plastic into fuel"],
    answer: 0,
    explanation: "Microorganisms decompose biodegradable waste into nutrient-rich manure during composting."
},

{
    ...
    difficulty: "Easy",
    pyq: false,
    question: "Vermicomposting makes use of:",
    options: ["Bacteria only", "Earthworms", "Fungi only", "Viruses"],
    answer: 1,
    explanation: "Earthworms speed up the decomposition of kitchen waste into compost."
},

{
    ...
    difficulty: "Easy",
    pyq: false,
    question: "Which of the following is a consumer?",
    options: ["Algae", "Mango tree", "Grasshopper", "Cactus"],
    answer: 2,
    explanation: "A grasshopper depends on plants for food, so it is a consumer."
},

{
    ...
    difficulty: "Easy",
    pyq: false,
    question: "The first trophic level in a pond ecosystem is formed by:",
    options: ["Frog", "Water snake", "Fish", "Phytoplankton"],
    answer: 3,
    explanation: "Phytoplankton are the microscopic producers in aquatic ecosystems."
},

{
    ...
    difficulty: "Easy",
    pyq: false,
    question: "The approximate efficiency of energy transfer from one trophic level to the next is:",
    options: ["10%", "50%", "90%", "1%"],
    answer: 0,
    explanation: "On average only about 10% of energy passes to the next trophic level."
},

{
    ...
    difficulty: "Medium",
    pyq: false,
    question: "Most of the energy at each trophic level is lost as:",
    options: ["Light", "Heat", "Food", "Water"],
    answer: 1,
    explanation: "Respiration and other life processes release most of the energy as heat."
},

{
    ...
    options: ["Sulphur dioxide", "Carbon dioxide", "CFCs", "Methane"],
    answer: 2,
    explanation: "The Montreal Protocol is an international agreement to phase out CFCs that deplete ozone."
},

{
    ...
    difficulty: "Medium",
    pyq: false,
    question: "A carnivore that eats herbivores occupies the:",
    options: ["Third trophic level", "Fourth trophic level", "First trophic level", "Second trophic level"],
    answer: 0,
    explanation: "Herbivores are T2, so the carnivores feeding on them are at T3."
},

{
    ...
    difficulty: "Easy",
    pyq: false,
    question: "Organisms that eat both plants and animals are called:",
    options: ["Carnivores", "Omnivores", "Decomposers", "Herbivores"],
    answer: 1,
    explanation: "Omnivores (e.g., humans, crows) eat both plant and animal food."
},

{
    ...
    options: ["Fungi", "Soil", "Insects", "Trees"],
    answer: 1,
    explanation: "Soil is a non-living (abiotic) component of the ecosystem."
},

{
    ...
    difficulty: "Medium",
    pyq: false,
    question: "The stability of an ecosystem depends on:",
    options: ["Cutting down producers", "Removing decomposers", "A balance between its components", "Increasing pollution"],
    answer: 2,
    explanation: "A balanced interaction among producers, consumers and decomposers keeps the ecosystem stable."
},

{
    ...
    options: ["Throwing waste in rivers", "Mixing all waste together", "Burning all waste", "Separating biodegradable from non-biodegradable waste"],
    answer: 3,
    explanation: "Separating waste at the source allows proper recycling and disposal."
},

{
    ...
    difficulty: "Easy",
    pyq: false,
    question: "Excess exposure to UV radiation can cause:",
    options: ["Better eyesight", "Stronger bones only", "No harm", "Skin cancer and cataract"],
    answer: 3,
    explanation: "UV radiation damages skin and eyes — skin cancer and cataract are major risks."
},

{
    ...
    difficulty: "Medium",
    pyq: false,
    question: "In a food chain with five trophic levels, the least energy is available at the:",
    options: ["First level", "Second level", "Third level", "Fifth level"],
    answer: 3,
    explanation: "Energy keeps decreasing at each step, so the top (fifth) level has the least energy."
},

{
    ...
    difficulty: "Medium",
    pyq: true,
    question: "If the producers receive 1000 J of energy, the amount available at the third trophic level is:",
    options: ["1000 J", "100 J", "10 J", "1 J"],
    answer: 2,
    explanation: "T1 = 1000 J → T2 = 100 J → T3 = 10 J."
},

{
    ...
    difficulty: "Medium",
    pyq: false,
    question: "Biological magnification is harmful to humans because:",
    options: ["Humans do not eat food", "It increases oxygen", "Humans are at the top of food chains", "Humans are producers"],
    answer: 2,
    explanation: "Toxins like pesticides reach their highest concentration in humans, who occupy top trophic levels."
},

{
    ...
    difficulty: "Easy",
    pyq: false,
    question: "Burning crop stubble (parali) mainly causes:",
    options: ["Air pollution", "Soil enrichment", "Ozone formation", "Water pollution"],
    answer: 0,
    explanation: "Open burning releases smoke and harmful gases — a major source of air pollution."
},

{
    ...
    options: ["Using CFC coolers", "Composting kitchen waste", "Burning plastic", "Dumping batteries in soil"],
    answer: 1,
    explanation: "Composting recycles biodegradable waste naturally without harming the environment."
},

{
    ...
    difficulty: "Medium",
    pyq: false,
    question: "Decomposers are not assigned a separate trophic level because they:",
    options: ["Are always absent", "Act at every trophic level", "Are very small", "Do not need energy"],
    answer: 1,
    explanation: "Decomposers break down dead material from all levels, so they operate at every trophic level."
},

{
    ...
    options: ["Water", "Plants", "Soil", "Sunlight"],
    answer: 3,
    explanation: "All energy in an ecosystem begins as solar energy trapped by producers."
},

{
    ...
    difficulty: "Easy",
    pyq: false,
    question: "Every food chain begins with a:",
    options: ["Decomposer", "Producer", "Carnivore", "Consumer"],
    answer: 1,
    explanation: "Producers start every food chain by capturing solar energy."
},

{
    ...
    difficulty: "Medium",
    pyq: false,
    question: "Assertion (A): Decomposers are also called reducers.\nReason (R): They reduce the organic matter of dead organisms into simple inorganic substances.",
    ...
    answer: 0,
    explanation: "Decomposers reduce complex dead matter into simple substances, hence the name 'reducers' — R explains A."
},

{
    ...
    difficulty: "Medium",
    pyq: false,
    question: "Case study: A school segregates its waste into Green bin (wet waste) and Blue bin (dry waste). Which item should go into the GREEN bin?",
    options: ["Aluminium can", "Plastic wrapper", "Glass bottle", "Leftover food"],
    answer: 3,
    explanation: "Wet, biodegradable waste like leftover food goes in the green bin for composting."
},

{
    ...
    difficulty: "Medium",
    pyq: false,
    question: "Case study: Farmers spray pesticide X on crops every season. After a few years, people eating the crop show higher pesticide levels than expected. This happens because of:",
    options: ["Photosynthesis", "Ozonation", "Biodegradation", "Biological magnification"],
    answer: 3,
    explanation: "Non-biodegradable pesticides accumulate and concentrate as they move up the food chain."
},

{
    ...
    difficulty: "Medium",
    pyq: false,
    question: "Case study: An energy pyramid shows T1 = 10,000 J. Which level would show approximately 100 J?",
    options: ["T3", "T4", "T5", "T2"],
    answer: 0,
    explanation: "T2 = 1000 J, T3 = 100 J — the third trophic level shows about 100 J."
},

{
    ...
    difficulty: "Medium",
    pyq: false,
    question: "Which organism is a secondary consumer?",
    options: ["Goat", "Frog", "Cow", "Grass"],
    answer: 1,
    explanation: "A frog eats insects (primary consumers), so it is a secondary consumer."
},

{
    ...
    difficulty: "Medium",
    pyq: false,
    question: "Which organism is a tertiary consumer?",
    options: ["Grass", "Grasshopper", "Frog", "Hawk"],
    answer: 3,
    explanation: "In Grass → Grasshopper → Frog → Hawk, the hawk is at the top — a tertiary consumer."
},

{
    ...
    difficulty: "Easy",
    pyq: false,
    question: "Nutrients are returned to the soil mainly by:",
    options: ["Transpiration", "Pollination", "Photosynthesis", "Decomposition"],
    answer: 3,
    explanation: "Decomposers break down dead matter and release nutrients back into the soil."
},

{
    ...
    difficulty: "Easy",
    pyq: false,
    question: "Which human activity increases biological magnification?",
    options: ["Excessive use of pesticides", "Using solar energy", "Rainwater harvesting", "Planting trees"],
    answer: 0,
    explanation: "Pesticides are non-biodegradable chemicals that magnify up the food chain."
},

{
    ...
    options: ["Grass, wheat and mango", "Grass, goat and human", "Goat, human and elephant", "Grass, fish and goat"],
    answer: 1,
    explanation: "A correct food chain is producer → herbivore → consumer: grass → goat → human (standard CBSE PYQ)."
},

{
    ...
    difficulty: "Medium",
    pyq: true,
    question: "The disposal of which waste is the biggest problem for the environment?",
    options: ["Cow dung", "Vegetable peel", "Paper", "Non-biodegradable waste"],
    answer: 3,
    explanation: "Non-biodegradable waste (plastics, e-waste) persists and pollutes for decades."
},

{
    ...
    difficulty: "Easy",
    pyq: false,
    question: "A lake, a forest and a grassland are all examples of:",
    options: ["Communities only", "Abiotic systems", "Populations", "Ecosystems"],
    answer: 3,
    explanation: "Each is an ecosystem — interacting biotic and abiotic components."
},

{
    ...
    difficulty: "Medium",
    pyq: false,
    question: "If deer are removed from the chain Grass → Deer → Tiger, what is the likely effect?",
    options: ["Grass increases and tigers decrease", "Both increase", "No change", "Grass decreases and tigers increase"],
    answer: 0,
    explanation: "Without deer, grass is not eaten (increases) and tigers lose their food (decrease)."
},

{
    ...
    difficulty: "Easy",
    pyq: false,
    question: "Which gas is essential for photosynthesis and is taken from the air by producers?",
    options: ["Oxygen", "Nitrogen", "Carbon dioxide", "Hydrogen"],
    answer: 2,
    explanation: "Producers use CO₂ from the atmosphere during photosynthesis."
},

{
    ...
    difficulty: "Medium",
    pyq: false,
    question: "Practice question: An ecosystem receives 100,000 J of sunlight. Producers trap about 1% of it. The energy available to the primary consumers will be:",
    options: ["10 J", "1000 J", "100 J", "10,000 J"],
    answer: 2,
    explanation: "Producers trap 1% of 100,000 J = 1,000 J. Primary consumers receive 10% of 1,000 J = 100 J."
},

{
    ...
    difficulty: "Medium",
    pyq: false,
    question: "Which statement about energy flow is correct?",
    options: ["Consumers create new energy", "Decomposers return energy to producers", "Energy cycles back to the Sun", "Energy flow is unidirectional and decreases at each level"],
    answer: 3,
    explanation: "Energy flows one way (Sun → producers → consumers) and is lost as heat at every step."
},

{
    ...
    difficulty: "Easy",
    pyq: false,
    question: "Which of these is a correct grassland food chain?",
    options: ["Grass → Grasshopper → Frog → Snake → Hawk", "Grasshopper → Grass → Frog → Hawk → Snake", "Frog → Grass → Snake → Grasshopper → Hawk", "Hawk → Snake → Frog → Grasshopper → Grass"],
    answer: 0,
    explanation: "Energy flows producer → primary consumer → secondary consumer → tertiary consumer → top carnivore."
}
